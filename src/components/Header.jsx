  ...
  return (
    <nav className='flex bg-blue-400 fixed w-full p-5 text-white'>
      ...
      <ul className='flex-1 text-right'>
        {insideHome && <li className='list-none inline-block px-5'><input onChange={e=>dispatch(searchProduct(e.target.value.toLowerCase()))} style={{ width: "300" }} className='rounded p-2' placeholder='Search products name' type='text' /></li>
        }
